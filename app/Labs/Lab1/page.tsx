    ...
    <div id="wd-lab1">
      ...
      <div id="wd-lists">
        ...
        <ol id="wd-your-favorite-recipe">
          <li>Collect 3 rocks.</li>
          <li>Microwave for 15 seconds.</li>
        ...
        <ul id="wd-your-books">
          <li>Thesaurus</li>
          <li>Book 2: The Sequel</li>
          <li>Lost and Found: A Guide to Reading</li>
        </ul>
      </div>
      <div id="wd-tables">
        <h4>Table Tag</h4>
        <table border={1} width="100%">
          ...
          <tbody>
            ...
            <tr>
              <td>Q5</td>
              <td>Barn Painting Techniques</td>
              <td>10/17/25</td>
              <td>99</td>
            </tr>
            <tr>
            ...
            <tr>
              <td>Q7</td>
              <td>The Phenomenon: Luigi Datome</td>
              <td>11/15/25</td>
              <td>100</td>
            </tr>
            <tr>
              <td>Q8</td>
              <td>Bagel Seasonings</td>
              <td>11/20/25</td>
              <td>93</td>
            </tr>
            <tr>
              <td>Q9</td>
              <td>Non-Aquatic Fish</td>
              <td>12/3/25</td>
              <td>97</td>
            </tr>
            <tr>
              <td>Q10</td>
              <td>The Sum of Human Knowledge</td>
              <td>12/5/25</td>
              <td>100</td>
            </tr>
          </tbody>
      ...
      Please{" "}
      <a
        href="https://github.khoury.northeastern.edu/rjmcnamara/kambaz-next-js"
        id="wd-github"
      >
        click here
      </a>
